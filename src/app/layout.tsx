...
export const metadata: Metadata = {
  title: 'Abishek Kumar | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Abishek Kumar! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
